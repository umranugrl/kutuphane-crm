            ...
            <div class="card-body">
                <div class="col-md-12">
                    <div style="text-align: right">
                        <a href="{{ route('author.index') }}" class="btn btn-success"><i
                                class="mdi mdi-arrow-left-bold-circle"></i></a>
                    </div>
                </div>
                <h4 class="card-title">@lang('author.author_edit')</h4>
                <form class="forms-sample" method="POST" action="{{ route('author.update', $author->id) }}">
                    @csrf
