                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            ...
                            <form class="pt-3" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="mt-3">
                                    <button type="submit"
                                        class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">@lang('auth.register')
                                    </button>
                                </div>
                                <div class="text-center mt-4 font-weight-light">
                                    @lang('auth.already_have_an_account') <a href="{{ route('login') }}"
                                        class="text-primary">@lang('auth.login')</a>
                                </div>
                            </form>
                        </div>
                    </div>
